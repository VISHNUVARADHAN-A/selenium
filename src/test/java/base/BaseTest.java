...
public class BaseTest {
    ...
    public void setUp() {
        ...
        for (int i = 0; i < 2; i++) { 
            try {
                ...
                if (!hosts.isEmpty()) {
                    ...
                    pathElement2 = shadowRoot.findElement(By.cssSelector("ins > span > svg > g"));
                    if (pathElement != null) {
        ...
        if (pathElement != null) {
            ...
            js.executeScript("arguments[0].dispatchEvent(new MouseEvent('click', {bubbles: true, cancelable: true}));", pathElement2);
